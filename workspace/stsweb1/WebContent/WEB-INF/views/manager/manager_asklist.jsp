...
<script>
    ...
    function goPage(pages) {
		location.href = "manager_asklist.do?pages=" + pages
    }
  
    function backPages(){
	    location.href ="manager_asklist.do?pages=" + 1
    }
</script>
</head>
<body>
        ...
        <div class="ask_list">
          ...
          <table class="reserv_list">
            ...
            <tr>
              ...
              <td><a href="manager_ask_detail.do?res_code=${list.res_code }">보기</a></td>
            </tr>
            </c:forEach>
          </table>
		<!-- 페이징  -->
